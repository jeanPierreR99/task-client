...
const FormSubTask = ({ subTaskId, setSubtaskFile }: any) => {
    ...
    const handleFileUpload = async () => {
        ...
        try {
            const response = await API.uploadFilesToSubTask(String(subTaskId), formData);
            ...
            setSubtaskFile((prev: any) => [...prev, ...response.data]);
            setFile([]);
            ToasMessage({
                title: "Éxito",
