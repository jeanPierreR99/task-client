                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    {fileData.map((folder: Folder, index: number) => (
                        <button
                            ...
                            key={index}
                            className="border text-left p-4 rounded-lg shadow hover:shadow-md transition duration-200 cursor-pointer bg-white"
                        >
                            <div className="flex flex-col gap-2 mb-2">
                                ...
                                {folder.totalFiles > 0 ? <span className="text-gray-400 italic">{folder.totalFiles} archivos</span> : <span className="text-gray-400 italic">Sin archivos</span>}
                            </div>
                        </button>
                    ))}
                </div>
